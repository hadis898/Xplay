...
function ckcpt(){
	...
	cpt += 'time.swf,2,0,-105,50,0 |';//当前时间插件
    return cpt;
}
/*
插件的定义结束
...
function ckstyle() { //定义总的风格
	...
	*/
	advmarquee:escape('{a href="http://blog.upx8.com" target="_blank"}{font color="#FFFFFF" size="12"}                    免费字幕广告：qq:66146221　　　{/font}{/a}'),
	/*
	...
	*/
	cpt_share:'http://blog.upx8.com/app/play/ckplayer/share.xml',
	/*
	分享插件调用的配置文件地址
	调用插件开始
	*/
